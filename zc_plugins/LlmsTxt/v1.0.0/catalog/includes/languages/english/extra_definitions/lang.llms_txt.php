 ...
 * plugin and translate the values; do the same for the admin copy in
 * `admin/includes/languages/<your language>/extra_definitions/lang.llms_txt_names.php`.
 *
 * %s in LLMSTXT_DEFAULT_SUMMARY is the store name.
 *
 * @package  LlmsTxt
