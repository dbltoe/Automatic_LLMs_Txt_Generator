...
- Builds an `llms.txt` ([llmstxt.org](https://llmstxt.org/)) from the store:
  ...
  category tree, products with prices, and published EZ-Pages. Optionally an
  `llms-full.txt` with longer descriptions.
...
[1.0.0]: https://github.com/dbltoe/LLMs_Txt_Generator/releases/tag/v1.0.0
